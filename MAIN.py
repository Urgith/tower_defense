...
class Update:
    ...
    def opponents_collision_base_player(self):
        ...
        if collided_opponent_index != -1:
            ...
            self.kill_opponent(collided_opponent_index, killed=False)
    ...
    def kill_opponent(self, index, killed=True):
        if killed:
            self.points += self.opponents[index].points
            self.money += self.opponents[index].money
...
class Draw:
    ...
    def blit_interface_and_player(self):
        player = self.player
...
class Game(Check, Update, Draw, OperateTower, Simple, Magic):
    ...
    def update(self):
        ...
        if self.opponents:
            ...
            self.opponents_collision_base_player()
    ...
    def draw(self):
        ...
        self.blit_interface_and_player()
